...
Когда вы объявляете значение по умолчанию для параметра, который не является path-параметром (на данный момент, мы пока познакомились только с query параметрами), то он становится необязательным.
